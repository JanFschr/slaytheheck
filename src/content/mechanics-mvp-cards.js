...
const definitions = [
	{
		...
		energy: 0,
		target: 'player',
		actions: [A('addResource', {resource: 'heat', amount: 2, max: 10}), A('gainEnergy', {amount: 1}), A('draw', {amount: 1})],
	...
	},
	{
		...
		actions: [A('spendResource', {resource: 'drones', amount: 1}), A('draw', {amount: 2}), A('gainEnergy', {amount: 1})],
