...
import {getCombatGoldReward, getTreasureGoldReward} from '../content/economy.js'
import {getEquipmentById} from '../content/equipment.js'
import {getRelicById} from '../content/relics.js'
import {createShopCard, getShopInventory} from '../content/shop.js'
...
function claimCombatGold(state) {
	...
	return produce(addGold(state, {amount}), (draft) => {
		...
		currentRoom.goldRewardClaimed = amount
	})
}
